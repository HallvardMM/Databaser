...
public class AddController {
	...
	public static void addFilm(Connection co, String tittel, int lengde, int utgivelsesAar, Date lanseringsdato,
			String storyline, String lagetFor, int utgittPaaVideo) throws SQLException {
	...
	public static void addSelskap(Connection co, String navn, int filmID, String url, String land, String adresse)
			throws SQLException {
	...
	public static void addEpisodeISerie(Connection co, int serieID, int filmID, String episode, String sesong)
			throws SQLException {
	...
	public static void addFilmAnmeldelse(Connection co, int brukerID, int filmID, String tekst, int rating)
			throws SQLException {
	...
	public static void addSerieAnmeldelse(Connection co, int brukerID, int serieID, String tekst, int rating)
			throws SQLException {
